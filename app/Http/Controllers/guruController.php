...
class guruController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect('/guru/index')->with('success', 'Data Guru Berasil Ditambah :) ');
    }
    ...
    public function update(Request $request, Guru $guru)
    {
       ...
       return redirect('guru/index')->with('success', 'Data Guru Berasil Diupdate :v ');
    }
    ...
    public function destroy(Guru $guru)
    {
        ...
        return redirect('/guru/index')->with('success', 'Data Berasil Dihapus :( ');
    }

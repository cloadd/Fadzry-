...
class jurusanController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect('/jurusan/index')->with('success', 'Data Jurusan Berasil Ditambah :) ');
    }
    ...
    public function update(Request $request,Jurusan $jurusan)
    {
       ...
       return redirect('jurusan/index')->with('success', 'Data Jurusan Berasil Diupdate :v ');
    }
    ...
    public function destroy(Jurusan $jurusan)
    {
        ...
        return redirect('/jurusan/index')->with('success', 'Data Berasil Dihapus :( ');
    }
}

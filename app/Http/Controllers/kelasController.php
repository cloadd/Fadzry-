...
class kelasController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect('/kelas/index')->with('success', 'Data Jurusan Berasil Ditambah :) ');
    }
    ...
    public function update(Request $request,Kelas $kelas)
    {
        ...
        return redirect('/kelas/index')->with('success', "Data Berasil Diupdate :) ");
    }
    ...
    public function destroy(Kelas $kelas)
    {
        ...
        return redirect('/kelas/index')->with('success', 'Data Berasil Dihapus :( ');
    }
}
